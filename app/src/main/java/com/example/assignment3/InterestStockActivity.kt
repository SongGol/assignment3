...
class InterestStockActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.interestSaveTv.setOnClickListener {
            ...
            SharedPreferenceManager.putObject(this, STOCK_DATA, defaultArrayList)
            finish()
        }
    ...
    private fun initializeDataSet() {
        ...
        default.add(Stock("테슬라", "US.TSLA","나스닥", "us", false, 66220, 68570, 66220, 68570, 0))
        ...
        default.add(Stock("펜 버지니아", "US.PVAC","나스닥", "us", false, 2251, 2327, 2251, 2327, 0))
